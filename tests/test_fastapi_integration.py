...
class TestFastAPIIntegrationWithEngine:
    def test_detect_endpoint_rodne_cislo(self, client_with_engine):
    ...
    def test_detect_endpoint_ico(self, client_with_engine):
        response = client_with_engine.post("/detect", json={
    ...
    def test_detect_endpoint_multiple_identifiers(self, client_with_engine):
        response = client_with_engine.post("/detect", json={
    ...
    def test_detect_endpoint_specific_detector(self, client_with_engine):
        response = client_with_engine.post("/detect", json={
    ...
    def test_detect_endpoint_no_pii(self, client_with_engine):
        response = client_with_engine.post("/detect", json={
    ...
    def test_validate_endpoint_rodne_cislo_valid(self, client_with_engine):
    ...
    def test_validate_endpoint_ico_valid(self, client_with_engine):
        response = client_with_engine.post("/validate", json={
            "value": "25596641",
            "detector_name": "ico",
            "regions": ["cz"]
    ...
    def test_validate_endpoint_invalid(self, client_with_engine):
        response = client_with_engine.post("/validate", json={
    ...
    def test_validate_endpoint_nonexistent_detector(self, client_with_engine):
        response = client_with_engine.post("/validate", json={
            "value": "8001011238",
    ...
    def test_list_detectors_endpoint_with_engine(self, client_with_engine):
        response = client_with_engine.get("/detectors")
    ...
    def test_health_endpoint(self, client_with_engine):
        response = client_with_engine.get("/health")

        assert response.status_code == 200
        assert response.json() == {"status": "healthy"}

    def test_detect_with_all_czech_detectors(self, client_with_engine):
        text = """
    ...
    def test_metadata_extraction_rodne_cislo(self, client_with_engine):
        response = client_with_engine.post("/detect", json={
            "text": "RČ: 8001011238",
            "regions": ["cz"]
        })
    ...
    def test_metadata_extraction_bank_account(self, client_with_engine):
        response = client_with_engine.post("/detect", json={
    ...
    def test_metadata_extraction_phone(self, client_with_engine):
        response = client_with_engine.post("/detect", json={
...
class TestFastAPIIntegrationDefault:
    def test_detect_with_regions(self, client_default):
        response = client_default.post("/detect", json={
            "text": "IČO: 25596641",
            "regions": ["cz"]
        })
    ...
    def test_list_detectors_requires_regions_without_engine(self, client_default):
        response = client_default.get("/detectors")

        assert response.status_code == 400

    def test_list_detectors_with_regions(self, client_default):
        response = client_default.get("/detectors", params={"regions": ["cz"]})
