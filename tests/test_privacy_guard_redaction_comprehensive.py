"""Comprehensive tests for PrivacyGuard redaction with ALL detector types."""

import pytest
from fastpii import PrivacyGuard


class TestPrivacyGuardRedactionAllDetectors:
    """Test redaction methods work for all registered detectors."""

    @pytest.fixture
    def guard(self):
        """Create PrivacyGuard instance."""
    ...
    def test_redact_all_detector_types(self, guard, text, pii_type, pii_value):
    ...
    def test_anonymize_all_detector_types(self, guard, text, pii_type, pii_value):
    ...
    def test_mask_all_detector_types(self, guard, text, pii_value):
    ...
    def test_remove_all_detector_types(self, guard, text, pii_value):
    ...
    def test_redact_multiple_different_pii_types(self, guard):
    ...
    def test_anonymize_multiple_pii_of_same_type(self, guard):
    ...
    def test_redact_preserves_text_structure(self, guard):
    ...
    def test_no_pii_detection_no_modification(self, guard):
    ...
    def test_empty_string_handling(self, guard):
    ...
    def test_custom_replacement_in_anonymize(self, guard):
        """Test anonymize with custom replacement string."""
        text = "Email: jan@email.cz"
        
        result = guard.anonymize(text, replacement="<PII_REMOVED>")
        
        assert "jan@email.cz" not in result
        assert "<PII_REMOVED>" in result

    def test_czech_domain_email_higher_confidence(self, guard):
